function createAbout() {
	...
	$('#container').append($('<div>',{id:'reference-window-back0', style:'left:36%;'}));
	...
	$('<div><h id="about_header">KDM Story app v.2.2</h><p id="about_p">Created by @prikhodkop</p><p id="about_p">Almost all the art and text presented in the app are the property of Adam Poots. The guy did a great job creating the game, so please pay respect to him and <b>use the app ONLY if you own a copy of the game</b> (no exceptions)!</p><p id="about_p">The app also uses some of content created by Fen, please support him at his: </br> https://www.patreon.com/FenPaints </br>He deservers it!.</p><p id="about_p">Hope you enjoy the app and please send your feedback to me!</p></div>').appendTo('#reference-window-back')
